...
# This class implements a Python interface to the 'WRENHandShakeMsg'
# message type.
#
...
class WRENHandShakeMsg(tinyos.message.Message.Message):
    # Create a new WRENHandShakeMsg of size 12.
